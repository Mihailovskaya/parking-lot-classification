...
def build_targets(p, targets, model):
    ...
    gain = torch.ones(6, device=targets._device)  # normalized to gridspace gain
    off = torch.tensor([[1, 0], [0, 1], [-1, 0], [0, -1]], device=targets._device).float()  # overlap offsets
